        ...
        context "for user references not existing" do
          it_behaves_like "format_text produces" do
            ...
            let(:expected) do
              <<~EXPECTED
                <p class="op-uc-p">
                  Link to user:"<a class="op-uc-link" rel="noopener noreferrer" target="_self" href="mailto:foo@bar.com">foo@bar.com</a>"
                </p>
              EXPECTED
            end
          end
          ...
          context "with only_path true (default)" do
            it_behaves_like "format_text produces" do
              ...
              let(:expected) do
                <<~EXPECTED
                  <p class="op-uc-p">
                    Link to <a class="user-mention op-uc-link" target="_self" href="/users/#{user.id}" title="User Foo Barrit">Foo Barrit</a>
                  </p>
                EXPECTED
              end
            end
          ...
          context "with only_path false (default)", with_settings: { host_name: "openproject.org" } do
            ...
            it_behaves_like "format_text produces" do
              ...
              let(:expected) do
                <<~EXPECTED
                  <p class="op-uc-p">
                    Link to <a class="user-mention op-uc-link" target="_self" href="http://openproject.org/users/#{user.id}" title="User Foo Barrit">Foo Barrit</a>
                  </p>
                EXPECTED
              end
            end
