    ...
    it_behaves_like "format_text produces" do
      ...
      let(:expected) do
        <<~EXPECTED
          ...
          <p class="op-uc-p">
            Inline reference to base_url variable: <a href="#{Rails.application.root_url}" target="_self" rel="noopener noreferrer"
               class="op-uc-link">#{Rails.application.root_url}</a>
          </p>
          <p class="op-uc-p">
            <a href="#{Rails.application.root_url}/foo/bar" target="_self" rel="noopener noreferrer"
